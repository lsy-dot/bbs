    ...
    <div class="right-main">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="nav">
                        <div class="titleShow"><h1>${section.sSectionname}版面的所有精华帖</h1></div>
                        <!--显示选择看帖子还是精华帖-->
                        <div class="selects">
                            <div class="row">
                                <ul class="nav nav-tabs">
                                    <li role="presentation"><a href="${APP_PATH}/section/thesection?sectionId=${section.sId}">帖子</a></li>
                                    <li role="presentation" class="active"><a href="${APP_PATH}/section/perfects?sectionId=${section.sId}">精华帖</a></li>
...
<%--                                        <tr>--%>
<%--                                            <td>${perfectPost.mMainid}</td>--%>
<%--                                            <td>${perfectPost.mTitle}</td>--%>
<%--                                            <td>${perfectPost.user.uNickname}</td>--%>
<%--                                            <td>${perfectPost.mMaindate}</td>--%>
<%--                                        </tr>--%>
<%--                                    </c:forEach>--%>
                                    </tbody>
                                </table>
            ...
            <div class="row">
                <div class="col-md-4">
                    <button class="btn btn-primary" id="cancelPerfects">从精华帖移除</button>
                </div>
            </div>
            <!--显示分页信息-->
            <div class="row">
